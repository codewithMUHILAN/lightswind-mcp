...
// Source paths from the package (referencing the original TS/TSX source code)
const libFrom = path.join(__dirname, "src", "components", "lib");
const styleFrom = path.join(__dirname, "src", "styles", "lightswind.css");
const hooksFrom = path.join(__dirname, "src", "components", "hooks");
const allUiFrom = path.join(__dirname, "src", "components", "ui");
